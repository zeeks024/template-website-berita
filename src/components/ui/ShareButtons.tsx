...
export default function ShareButtons({ title, url }: { title: string, url: string }) {
    ...
    const btnBase = "w-10 h-10 rounded-full bg-muted border border-border flex items-center justify-center text-muted-foreground transition-all hover:scale-110 active:scale-95";
    ...
    return (
        <div className="flex flex-wrap items-center gap-2">
            ...
            <button
                ...
                className={`${btnBase} hover:bg-[#25D366] hover:text-white hover:border-[#25D366]`}
            ...
            <button
                ...
                className={`${btnBase} hover:bg-foreground hover:text-background hover:border-foreground`}
