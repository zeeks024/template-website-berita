...
export const metadata: Metadata = {
    ...
    description: 'Mengenal lebih dekat visi dan misi Derap Serayu sebagai platform komunitas Banjarnegara.',
};
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <FadeIn>
                    <div className="text-center mb-16 space-y-4">
                        ...
                        <p className="text-xl text-white/60 max-w-2xl mx-auto font-light leading-relaxed">
                            Bukan sekadar portal berita. Derap Serayu adalah ruang kolektif untuk merayakan narasi lokal, potensi tersembunyi, dan denyut nadi kehidupan Banjarnegara.
                        </p>
                    </div>
                </FadeIn>
                ...
                <div className="space-y-24">
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-black text-white uppercase tracking-tight mb-4">Bergabunglah Bersama Kami</h2>
                        <p className="text-white/40">Kami selalu terbuka untuk kolaborasi dan kontribusi dari seluruh warga Banjarnegara.</p>
                    </div>
                </div>
            </div>
        </main>
