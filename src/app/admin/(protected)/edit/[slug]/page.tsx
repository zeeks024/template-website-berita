        ...
        <FadeIn>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
                <div className="lg:col-span-2 space-y-6">
                    <SectionHeader
                        ...
                        action={
                            <div className="flex items-center gap-3">
                                ...
                                <Link 
                                    href="/admin" 
                                    className="px-4 py-2 bg-white/5 hover:bg-white/10 text-white/60 hover:text-white rounded-xl text-sm font-medium flex items-center gap-2 transition-all"
                                >
                                    <ArrowLeft size={16} />
                                    Kembali
                                </Link>
                    ...
                    <Card>
                        <label className="text-xs font-bold uppercase tracking-wider text-white/40 flex items-center gap-2 mb-4">
                        ...
                        <input
                            ...
                            className="w-full bg-black/30 border border-white/10 rounded-xl p-5 text-xl font-bold text-white placeholder:text-white/20 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition-all"
                        />
                    </Card>
                    ...
                    <Card>
                        ...
                        <textarea
                            ...
                            className="w-full bg-black/30 border border-white/10 rounded-xl p-5 text-base text-white placeholder:text-white/20 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition-all resize-none"
                        />
                    </Card>
                    ...
                    <Card>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mt-4">
                            <input
                                className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-cyan-500 focus:outline-none transition-all"
                ...
                <div className="space-y-6">
                    <Card className="sticky top-8 border-amber-500/20 bg-gradient-to-b from-admin-surface to-admin-surface/80">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-sm">Publikasi</h3>
                                <p className="text-white/40 text-xs">Simpan perubahan artikel</p>
                            </div>
                        </div>
                            ...
                            {isAdmin && (
                                <div className="flex items-center justify-between p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-white/80">Pilihan Editor</span>
                                    </div>
                                    <button
                                        type="button"
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-white/5 hover:bg-white/10 text-white/60 hover:text-white rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition-all"
                            >
                                <X size={16} /> Batal
                            </button>
                        </div>
                    ...
                    <Card>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-sm">Pengaturan</h3>
                                <p className="text-white/40 text-xs">Kategori & metadata</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-cyan-500 focus:outline-none transition-all"
                    ...
                    <Card>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-white/40 text-xs">Optimasi mesin pencari</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    rows={3}
                                    className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-cyan-500 focus:outline-none transition-all resize-none"
